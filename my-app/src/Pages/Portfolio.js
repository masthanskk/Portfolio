...
export default function Portfolio() {
  return (
    <div className="flex min-h-screen">
      ...
      <img  className="h-24 w-24 rounded-full mb-4" src="https://i.ibb.co/4FKbFsq/IMG-0185-1.jpg"  border="0" />
      ...
      <div className="w-3/4 p-16 bg-gray-100 flex flex-col space-y-8">
        ...
        <div className="flex space-x-8 text-lg">
          <a  className="text-gray-900 font-bold">All</a>
          <a  className="text-gray-600">Graphic Design</a>
          <a  className="text-gray-600">Web Design</a>
          <a  className="text-gray-600">Photography</a>
        </div>
